...
// sets up the necessary properties for movement
...
// Creates coin with slight movement
function Coin(pos) {
...
// Encapsulating the drawing code as display Object

  // helper function that creates element with a class
...
// scales grid squares up by factor of N pixels
let scale = 20;
...
DOMDisplay.prototype.scrollPlayerIntoView = function() {
  ...
  if(center.y < top + margin) {
    this.wrap.scrollTop = center.x - margin;
